...
coordinaten <- coordinaten_orig %>%
  select(plot_id = idplots, x, y, type_coord = type, vbi_cycle = periode, plotweight)
# 
...
write_vc(coordinaten, "coordinates", root = path, sorting = c("plot_id", "vbi_cycle"), strict = FALSE)
