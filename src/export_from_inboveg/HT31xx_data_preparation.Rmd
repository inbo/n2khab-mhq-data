...
* measured (TRUE/FALSE): geeft aan of er al dan niet een volledige vegetatieopname is uitgevoerd (TRUE); een onvolledige opname (geen structuur- of layerkenmerken genoteerd) wordt als FALSE beschouwd  
...
vegetation <- vegetation_31xx %>% 
  mutate(name = ifelse(is.na(name_scientific), name_original, name_scientific),
         name = case_when(
           ...
           name_original %in% c("Enteromorpha", "Enteromorpha spec.") ~ "Enteromorpha spec.",
           name_original %in% 
