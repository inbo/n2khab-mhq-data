...
coordinates_moneos <- read_csv2(file.path(path, "raw/coordinates_inbo/CoordinatenExtraPQ_LSVI_91E0_2023-12-07.csv")) %>%
...
write_vc(coordinates_moneos, "coordinaten_moneos", root = path, sorting = c("plot_id", "plot_pl"))
```
