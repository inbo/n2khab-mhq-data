...
classif_mhq <- bind_rows(
    ...
    get_inboveg_classification(connection = connection_inboveg, survey_name = "N2000meetnet_Bos_91E0_sf", collect = TRUE)
) %>%
...
header_mhq <- bind_rows(
    ...
    get_inboveg_header(connection = connection_inboveg, survey_name = "N2000meetnet_Bos_91E0_sf", collect = TRUE)) %>%
...
recordings_mhq <- bind_rows(
    get_inboveg_recording(connection = connection_inboveg, survey_name = "N2000meetnet_Grasland", collect = TRUE),
    get_inboveg_recording(connection = connection_inboveg, survey_name = "N2000meetnet_Moerassen", collect = TRUE),
    get_inboveg_recording(connection = connection_inboveg, survey_name = "N2000meetnet_Grasland_BHM", collect = TRUE),
    get_inboveg_recording(connection = connection_inboveg, survey_name = "N2000meetnet_Moeras_BHM", collect = TRUE),
    get_inboveg_recording(connection = connection_inboveg, survey_name = "N2000meetnet_Duinen_BHM", collect = TRUE),
    get_inboveg_recording(connection = connection_inboveg, survey_name = "N2000meetnet_Bos_91E0_sf", collect = TRUE)) %>%
...
qualifiers_mhq <- bind_rows(get_inboveg_qualifier(connection = connection_inboveg, survey_name = "N2000meetnet_Grasland", qualifier_type = "MQ"),
                            get_inboveg_qualifier(connection = connection_inboveg, survey_name = "N2000meetnet_Moerassen", qualifier_type = "MQ"),
                            get_inboveg_qualifier(connection = connection_inboveg, survey_name = "N2000meetnet_Grasland_BHM", qualifier_type = "MQ"),
                            get_inboveg_qualifier(connection = connection_inboveg, survey_name = "N2000meetnet_Moeras_BHM", qualifier_type = "MQ"),
                            get_inboveg_qualifier(connection = connection_inboveg, survey_name = "N2000meetnet_Duinen_BHM", qualifier_type = "MQ"),
                            get_inboveg_qualifier(connection = connection_inboveg, survey_name = "N2000meetnet_Bos_91E0_sf", qualifier_type = "MQ")) %>%
