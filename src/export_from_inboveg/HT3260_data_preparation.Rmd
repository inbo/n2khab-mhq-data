...
- value: waarde van meting of klasse (tekstveld)
...
- is_numeric: TRUE voor variabelen met numerieke waarden (genoteerd in value_numeric) of FALSE voor klasse-variabelen  
...
site_characteristics %>% 
  select(var) %>% 
  arrange(var) %>% distinct()
# to do: vereenvoudigen van variabelen-naam "manier waarop de opname gemaakt is", "helderheid van de waterkolom", ...
```
