...
db_fieldmap_foresthab <- file.path(fileman_up("data"), "database_forest_2020-08-11/FIELDMAPDATA_BOSHAB_F_V2020_MASTER.FDB")

db_fieldmap_openhab <- file.path(fileman_up("data"),"database_heath6510_2020-08-11/FIELDMAPDATA_MASTER_NAT2000_F_V6.FDB")

# file.exists(db_fieldmap_openhab)
# file.exists(db_fieldmap_foresthab)
...
gridpoints <- gridpoints_orig %>%
    ...
    mutate(status_fieldwork = ifelse(status_fieldwork == 2, "nee", 
                                     ifelse(status_fieldwork == 1, "ja", NA)))
...
```{r}
# corrections -> to be changed in database! --> OK
