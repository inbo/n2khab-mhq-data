...
db_fieldmap_foresthab <- "../../data/database_forest_2020-06-04/FIELDMAPDATA_BOSHAB_F_V2020_QC202004.FDB"
db_fieldmap_openhab <- "../../data/database_heath6510_2020-06-12/FIELDMAPDATA_MASTER_NAT2000_F_V5.FDB"
```
...
check_missing_data <- sample_status %>%
    ...
    mutate(assessment_source = ifelse(status_fieldwork == "ja", "field assessment",
           ...
           structure_opebhab_record = ifelse(db == "openhab", plot_id %in% structure_vars$plot_id, NA))
...
check_missing_data_openhab <- check_missing_data %>%
    ...
    filter(is.na(type_observed_circle) |
               ...
               !structure_opebhab_record) %>%
    select(plot_id, status_fieldwork, info_status_fieldwork, remark, type_observed_circle, date_assessment, coordinates_record, cover_species_record, structure_opebhab_record) 
...
check_missing_data_openhab2 <- check_missing_data %>%
    ...
    filter(cover_species_record |
               structure_opebhab_record) %>%
    select(plot_id, status_fieldwork, info_status_fieldwork, remark, type_observed_circle, date_assessment, cover_species_record, structure_opebhab_record) 
