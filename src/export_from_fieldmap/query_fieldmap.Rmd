...
```{r dbINBO, eval=FALSE, include=FALSE}
...
# v5 - check_missing_data <- sample_status %>%
...
A plot is regarded as not measured when 'status_fieldwork' = 'nee' or when 'info_status_fieldwork' is not NA (untill version v5 db open). 
A plot is regarded as not measured when 'targethabitat' = 'onbekend' or 'nee' or targethabitat = 'ja' and ('status_fieldwork_opnameuitgevoe' = 'geen opname gevraagd' or 'geen opname uitgevoerd' or 'opname gedeeltelijk uitgevoerd'). 

Possible actions:

- When all vegetation and structure records are recorded:
    - set 'info_status_fieldwork' to NA (v5)
    - adjust 'info_status_fieldwork_nogtw' and 'status_fieldwork_opnameuitgevoe'

- When vegetation and structure records are partially recorded:
    - check 'info_status_fieldwork' (v5) or info_status_fieldwork_nogtw (v7)
...
## v5 - Plots with status_fieldwork == "nee" & info_status_fieldwork == "Geen opname : geen doelhabitat"
