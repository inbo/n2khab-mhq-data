...
db_fieldmap_foresthab_vbi3 <- file.path(fileman_up("n2khab-mhq-data"), "raw/fieldmap_foresthab/fieldmap_foresthab_v2023.FDB")
...
```{r}
get_plot_status_vbi3 <- function(db = db_fieldmap_foresthab_vbi3){
...
get_treesa3a4_vbi3 <- function(db = db_fieldmap_foresthab_vbi3){
...
write_vc(coordinates_date, "coordinates", root = path,  sorting = c("plot_id", "date_assessment"))
