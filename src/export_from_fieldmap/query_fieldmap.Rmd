...
assessments_openhab <- check_missing_data %>%
  filter(db == "openhab") %>%
    select(plot_id, sampling_unit_code, targethabitat, status_fieldwork,info_status_fieldwork, assessment_source, inaccessible, not_measurable, type_observed,  lsvi_measurement, remark, structure_openhab_record, cover_species_record)
...
write_vc(assessments_openhab, root = path,  "assessments_openhab", sorting = "plot_id")
